...
require("lazy").setup({
  ...
  spec = {
    ...
    { import = "plugins.Treesitter" }, -- 语法高亮系统
    { import = "plugins.Snacks" },   -- 实用工具集合
    { import = "plugins.Markdown" }, -- Markdown 专用支持
    { import = "plugins.Blink" },    -- 快速导航插件
    { import = "plugins.Dap" },      -- 调试适配器协议
	{ import = "plugins.AI" },      -- AI工具
    { import = "plugins.Extras" },   -- 其他辅助插件
  },
